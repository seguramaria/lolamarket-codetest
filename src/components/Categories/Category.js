  ...
  if (props.filteredMarketById) {
    return (
      <>
        ...
        >
          <img
            className="categories__list__item--icon"
            src={props.icon ? props.icon : logoCategory}
            alt="Icono de la categoría"
          ></img>
          <div className="categories__list__item--category">
            <p className="categories__list__item--category--title">
              {props.name}
            </p>
            <img
              className={`categories__list__item--category--arrow ${
          ...
          >
            ...
            <li className="categories__sublist__item">
              <div className="categories__sublist__item__container">
                ...
                <img
                  className="categories__sublist__item__container--check hidden"
                  src={checked}
